...
// styled-components란?
// CSS 문법을 그대로 사용하면서 결과물로 스타일링된 컴포넌트 만들어주는 라이브러리
// 컴포넌트 개념을 사용하기 떄문에 리액트와 궁합이 잘 맞음
...
const Wrapper = styled.div`
  ...
  /* 6. 반응형 디자인 
    - 일반 css를 사용할 떄와 똑같이 미디어 쿼리 사용 가능
    - 리액트스럽게 react-responsive 라이브러리 사용
  */
    
  /* 기본적으로 가로 길이를 1024px에 가운데 정렬하고
    가로 크기가 작아짐에 따라 크기를 줄이고 768px미만이 되면 꽉 채우기 */
    width: 1024px;
    margin: 0 auto;
...
function StyledPage() {
  return (
    <Wrapper>
      <Title>안녕, 리액트!</Title>
      <Button width="200px" height="60px">눌러볼래?</Button>

      {/* $는 스타일 지정만을 위한 prop이 DOM 요소로 렌더링되는 것을  */}
      {/* 방지하기위해 붙여 임시 prop으로 전환할 수 있다. */}
